 ...
 Característica: Transferencia a cuenta de corriente en app Bancolombia
   ...
   @manual
   Esquema del escenario: transferencia de deposito a cuenta corriente superando el saldo disponible de la cuenta
     Dado que <usuario> esta en la APP en el dispositivo <dispositivo>
     ...
     Ejemplos:
       ...
       | Juan     | Android     |  con saldo   		    | Ahorros       |    Corriente             |  DISPONIBLE INSUFICIENTE EN CUENTA A DEBITAR            |


   @manual
   Esquema del escenario: transferencia bancolombia desde cuenta deposito a cuenta corriente
     Dado que <usuario> esta en la APP en el dispositivo <dispositivo>
     Cuando selecciona la opcion TRANSFERIR_DINERO y realizar una transferencia con <saldo> de <cuentaOrigen> a <cuentaDestino>
     Entonces deberia ver el mensaje <mensaje>
     Y se verifica el archivo COMMFFLGWWW
     ...
     Ejemplos:
       | usuario  | dispositivo |   saldo      		    | cuentaOrigen  |   cuentaDestino  	      |  mensaje                       |
       | Juan     | Android     |  con saldo   		    | Ahorros       |    Corriente             |  TRASNFERENCIA EXITOSA           |
